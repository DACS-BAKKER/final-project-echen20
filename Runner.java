...
public class Runner {
    ...
    static Game pandemic;
    static LinkedList<City[]> connections = new LinkedList<>();
    ...
    public static City[] loadCardsFromTxt() throws IOException { // loads all of the cards from the text file using a
                                                                 // buffered reader
        BufferedReader buf = new BufferedReader(new FileReader(new File("src/Locations.txt"))); // real txt file
       // BufferedReader buf = new BufferedReader(new FileReader(new File("src/Blue.txt"))); // tester txt file
